...
namespace Assisticant
{
    public static class AssisticantReflectionUtils
    {
        ...
        public static IEnumerable<T> GetCustomAttributesPortable<T>(this PropertyInfo property)
            where T : Attribute
        {
            return property.CustomAttributes.OfType<T>();
        }
#else
        ...
        public static IEnumerable<T> GetCustomAttributesPortable<T>(this PropertyInfo property)
            where T: Attribute
        {
            return property.GetCustomAttributes(typeof(T), false).OfType<T>();
        }
#endif
    }
}
